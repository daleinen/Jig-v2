    ...
    for dis_range in [up_range,down_range]:
        ...
        for i in dis_range:
            ...
            if yes == 1:
                ...
                badness_score = 1 + (penalty * (abs((i - n) / n)))
                badness_score *= piece_ratio
                ...
                print(f"{best_n} pieces in {best_n_sides} (grid ratio = {round(best_n_ratio,4)}) (easy ratio = {round(piece_ratio,4)}) (poorness ratio = {round(badness_score,5)})")
